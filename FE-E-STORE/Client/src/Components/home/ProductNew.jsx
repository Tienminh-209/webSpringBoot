...
class ProductNew extends Component {
  ...
  hotBest(currentPage) {
    currentPage -= 1;
    ProductService.getHotNew(currentPage, this.state.size)
  ...
  render() {
    return (
      <div>
        ...
        {/* <a href="http://localhost:3000/product/san-pham-moi"> <button style={{width:"137px",marginLeft:"575px",marginTop:"17px",padding:"6px",fontSize:"14px",backgroundColor:"white",color:"black"}}>XEM THÊM</button></a> */}
      </div>
      </div>
    );
  }
